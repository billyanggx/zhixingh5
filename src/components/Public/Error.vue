<template>
  <div class="error-panel animated fadeInUp">
    ...
    <div class="error-ctrl">
      <span type="info" @click="$router.push({path: '/home'})" round><i class="fa fa-home"></i>&nbsp;主页</span>
      <span @click="$router.back()" round plain><i class="fa fa-arrow-left"></i>&nbsp;返回</span>
    </div>
    <p class="copyright">@tsl 版权所有</p>
  </div>
</template>
<script>
export default {
